...
public class ServiceiLibrary : IServiceiLibrary
{
    ...
    public StartLotResult StartLot(string lotNo, string mcNo, string opNo,string recipe)
    {
        ...
        try
        {
            ...
            if (!proResult.IsPass)
            {
                return new StartLotResult(proResult.Cause, "LotNo:" + lotNo + " opNo:" + opNo + " package:" + lotInfo.Package.Name, MethodBase.GetCurrentMethod().Name, log);
            }
    ...
    public UpdateFirstinspectionResult UpdateFirstinspection(string lotNo, string opNo, Judge judge, string mcNo)
    {
        ...
        try
        {
            ...
            if (!proResult.IsPass)
            {
                return new UpdateFirstinspectionResult(proResult.Cause, "LotNo:" + lotNo + " opNo:" + opNo + " package:" + lotInfo.Package.Name, MethodBase.GetCurrentMethod().Name, log);
            }
    ...
    public UpdateFinalinspectionResult UpdateFinalinspection(string lotNo, string opNo, Judge judge, string mcNo)
    {
        ...
        try
        {
            ...
            if (!proResult.IsPass)
            {
                return new UpdateFinalinspectionResult(proResult.Cause, "LotNo:" + lotNo + " opNo:" + opNo + " package:" + lotInfo.Package.Name, MethodBase.GetCurrentMethod().Name, log);
            }

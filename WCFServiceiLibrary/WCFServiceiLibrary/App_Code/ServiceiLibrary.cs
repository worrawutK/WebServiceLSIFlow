...
public class ServiceiLibrary : IServiceiLibrary
{
    ...
    public SetupLotResult SetupLot(string lotNo, string mcNo, string opNo, string processName ,string layerNo)
    {
        ...
        try
        {
            ...
            if (lotInfo == null)
                return new SetupLotResult(false, "ไม่พบ lotNo :" + lotNo + " ในระบบ","LotNo:" + lotNo + " opNo:" + opNo , "", MethodBase.GetCurrentMethod().Name, log);

            //Check package and Lot Pro
            CheckLotApcsProResult proResult = CheckLotApcsPro(lotNo, lotInfo.Package.Name, log);
            if (!proResult.IsPass)
            {
                return new SetupLotResult(false,proResult.Cause, "LotNo:" + lotNo + " opNo:" + opNo + " package:" + lotInfo.Package.Name, "", MethodBase.GetCurrentMethod().Name, log);
            }
            ...
            if (!permissionResult.IsPass)
                  return new SetupLotResult(false, permissionResult.ErrorNo + ":" + permissionResult.ErrorMessage, "LotNo:" + lotNo + " opNo:" + opNo + " processName:" + processName, "", MethodBase.GetCurrentMethod().Name, log);

         
            MachineInfo machineInfo = c_ApcsProService.GetMachineInfo(mcNo, log, dateTimeInfo.Datetime);
            if (machineInfo == null)
                return new SetupLotResult(false, "ไม่พบ MCNo :" + mcNo + " ในระบบ", "LotNo:" + lotNo + " opNo:" + opNo + " mcNo" + mcNo, "", MethodBase.GetCurrentMethod().Name,log);
            ...
            if (!lotUpdateInfo.IsOk)
                 return new SetupLotResult(false,lotUpdateInfo.ErrorNo + ":" + lotUpdateInfo.ErrorMessage, "LotNo:" + lotNo + " opNo:" + opNo, "", MethodBase.GetCurrentMethod().Name,log); 
            
            return new SetupLotResult(true, warningMessage, "", lotUpdateInfo.Recipe1, MethodBase.GetCurrentMethod().Name, log);

        }
        catch (Exception ex)
        {
            return new SetupLotResult(false,ex.Message.ToString(), "LotNo:" + lotNo + " opNo:" + opNo, "", MethodBase.GetCurrentMethod().Name, log);
        }
    }
    ...
    public OnlineStartResult OnlineStart(string lotNo,string mcNo,string opNo)
    {
        ...
        try
        {
            ...
            LotInfo lotInfo = c_ApcsProService.GetLotInfo(lotNo, log, dateTimeInfo.Datetime);
            if (lotInfo == null)
                return new OnlineStartResult("ไม่พบ lotNo :" + lotNo + " ในระบบ", "LotNo:" + lotNo + " opNo:" + opNo, MethodBase.GetCurrentMethod().Name, log);

            //Check package and Lot Pro
            CheckLotApcsProResult proResult = CheckLotApcsPro(lotNo, lotInfo.Package.Name, log);
            if (!proResult.IsPass)
            {
                return new OnlineStartResult(proResult.Cause, "LotNo:" + lotNo + " opNo:" + opNo + " package:" + lotInfo.Package.Name, MethodBase.GetCurrentMethod().Name, log);
            }
            ...
            MachineInfo machineInfo = c_ApcsProService.GetMachineInfo(mcNo, log, dateTimeInfo.Datetime);
            if (machineInfo == null)
                return new OnlineStartResult("ไม่พบ MCNo :" + mcNo + " ในระบบ", "LotNo:" + lotNo + " opNo:" + opNo + " mcNo" + mcNo, MethodBase.GetCurrentMethod().Name, log);
            ...
            if (!lotUpdateInfo.IsOk)
                return new OnlineStartResult(lotUpdateInfo.ErrorNo + ":" + lotUpdateInfo.ErrorMessage, "LotNo:" + lotNo + " opNo:" + opNo + " mcNo:" + mcNo, MethodBase.GetCurrentMethod().Name, log);

            return new OnlineStartResult(MethodBase.GetCurrentMethod().Name,log);
        }
        catch (Exception ex)
        {
            return new OnlineStartResult(ex.Message.ToString(), "LotNo:" + lotNo + " opNo:" + opNo + " mcNo:" + mcNo, MethodBase.GetCurrentMethod().Name, log);
        }
    }
    ...
    public StartLotResult StartLot(string lotNo, string mcNo, string opNo,string recipe)
    {
        ...
        try
        {
            ...
            return new StartLotResult(MethodBase.GetCurrentMethod().Name,log);
        }
        catch (Exception ex)
        {
    ...
    public OnlineEndResult OnlineEnd(string lotNo,string mcNo,string opNo,int good ,int ng)
    {
        ...
        try
        {
            ...
            LotInfo lotInfo = c_ApcsProService.GetLotInfo(lotNo, log, dateTimeInfo.Datetime);
            if (lotInfo == null)
                return new OnlineEndResult("ไม่พบ lotNo :" + lotNo + " ในระบบ", "LotNo:" + lotNo + " opNo:" + opNo, MethodBase.GetCurrentMethod().Name, log);

            //Check package and Lot Pro
            CheckLotApcsProResult proResult = CheckLotApcsPro(lotNo, lotInfo.Package.Name, log);
            if (!proResult.IsPass)
            {
                return new OnlineEndResult(proResult.Cause, "LotNo:" + lotNo + " opNo:" + opNo + " package:" + lotInfo.Package.Name, MethodBase.GetCurrentMethod().Name, log);
            }
            ...
            MachineInfo machineInfo = c_ApcsProService.GetMachineInfo(mcNo, log, dateTimeInfo.Datetime);
            if (machineInfo == null)
                return new OnlineEndResult("ไม่พบ MCNo :" + mcNo + " ในระบบ", "LotNo:" + lotNo + " opNo:" + opNo + " mcNo" + mcNo, MethodBase.GetCurrentMethod().Name, log);

            LotUpdateInfo lotUpdateInfo = c_ApcsProService.OnlineEnd(lotInfo.Id, machineInfo.Id, userInfo.Id,false, good, ng, 0, "", 1, dateTimeInfo.Datetime, log);
            if (!lotUpdateInfo.IsOk)
                return new OnlineEndResult(lotUpdateInfo.ErrorNo + ":" + lotUpdateInfo.ErrorMessage, "LotNo:" + lotNo + " opNo:" + opNo + " mcNo:" + mcNo + " good:" + good + " ng:" + ng, MethodBase.GetCurrentMethod().Name, log);

            return new OnlineEndResult(MethodBase.GetCurrentMethod().Name,log);

        }
        catch (Exception ex)
        {
            return new OnlineEndResult(ex.Message.ToString(), "LotNo:" + lotNo + " opNo:" + opNo + " mcNo:" + mcNo + " good:" + good + " ng:" + ng, MethodBase.GetCurrentMethod().Name, log);
    ...
    public UpdateFinalinspectionResult UpdateFinalinspection(string lotNo, string opNo, Judge judge, string mcNo)
    {
        ...
        try
        {
            ...
            return new UpdateFinalinspectionResult(MethodBase.GetCurrentMethod().Name,log);
        }
        catch (Exception ex)
        {
    ...
    public EndLotResult EndLot(string lotNo, string mcNo, string opNo, int good, int ng)
    {
        ...
        try
        {
            ...
            return new EndLotResult(MethodBase.GetCurrentMethod().Name,log);
        }
        catch (Exception ex)
        {
    ...
    public CancelLotResult CancelLot(string mcNo,string lotNo,string opNo)
    {
        ...
        try
        {
            ...
            return new CancelLotResult(MethodBase.GetCurrentMethod().Name,log); 
        }
        catch (Exception ex)
        {
    ...
    private ReinputResult AbnormalLotEnd_BackToThe_BeforeProcess(string lotNo, string mcNo, string opNo, int good, int ng, bool holdLot,string functionName)
    {
        ...
        try
        {
            ...
            LotInfo lotInfo = c_ApcsProService.GetLotInfo(lotNo, log, dateTimeInfo.Datetime);
            if (lotInfo == null)
                return new ReinputResult("ไม่พบ lotNo :" + lotNo + " ในระบบ", "LotNo:" + lotNo + " opNo:" + opNo + " mcNo:" + mcNo + " good:" + good + " ng:" + ng, functionName, log);
            //Check package and Lot Pro
            CheckLotApcsProResult proResult = CheckLotApcsPro(lotNo, lotInfo.Package.Name, log);
            if (!proResult.IsPass)
            {
                return new ReinputResult(proResult.Cause, "LotNo:" + lotNo + " opNo:" + opNo + " mcNo:" + mcNo, functionName, log);
            }
            ...
            MachineInfo machineInfo = c_ApcsProService.GetMachineInfo(mcNo, log, dateTimeInfo.Datetime);
            if (machineInfo == null)
                return new ReinputResult("ไม่พบ MCNo :" + mcNo + " ในระบบ", "LotNo:" + lotNo + " opNo:" + opNo + " mcNo:" + mcNo + " good:" + good + " ng:" + ng, functionName, log);
            ...
            if (!lotUpdateInfo.IsOk)
            {
                return new ReinputResult(lotUpdateInfo.ErrorMessage, "LotNo:" + lotNo + " opNo:" + opNo + " mcNo:" + mcNo + " good:" + good + " ng:" + ng, functionName, log);
            }
            return new ReinputResult(functionName, log);
        }
        catch (Exception ex)
        {
            return new ReinputResult(ex.Message.ToString(), "LotNo:" + lotNo + " opNo:" + opNo + " mcNo:" + mcNo + " good:" + good + " ng:" + ng, functionName, log);
        }
    }
    #endregion
    ...
    public MachineOnlineStateResult MachineOnlineState(string mcNo, MachineOnline online)
    {
        ...
        try
        {
            ...
            return new MachineOnlineStateResult(MethodBase.GetCurrentMethod().Name,log);
        }
        catch (Exception ex)
        {
    ...
    public MachineAlarmResult MachineAlarm(string lotNo, string mcNo, string opNo ,string AlarmNo, AlarmState alarm)
    {
        ...
        try
        {
            ...
            return new MachineAlarmResult(MethodBase.GetCurrentMethod().Name,log);
        }
        catch (Exception ex)
        {
    ...
    public CheckLotApcsProResult CheckLotApcsProManual(string lotNo, string mcNo, string package)
    {
        ...
        try
        {
            ...
            {
                log.ConnectionLogger.Write(0, MethodBase.GetCurrentMethod().Name, "Error", "WCF Service", "iLibrary", 0, "CheckLotApcsProManual", "lotNo:" + lotNo + " mcNo:" + mcNo + " package:" + package + " cause:" + apcsProResult.Cause, "");
            }
            else
            {
                log.ConnectionLogger.Write(0, MethodBase.GetCurrentMethod().Name, "Normal", "WCF Service", "iLibrary", 0, "CheckLotApcsProManual", "lotNo:" + lotNo + " mcNo:" + mcNo + " package:" + package + " cause:" + apcsProResult.Cause, "");
            }
            return apcsProResult;
        }
        catch (Exception ex)
        {
            log.ConnectionLogger.Write(0, MethodBase.GetCurrentMethod().Name, "Error", "WCF Service", "iLibrary", 0, "CheckLotApcsProManual", "lotNo:" + lotNo + " mcNo:" + mcNo + " package:" + package + " Exception:" + ex.ToString(),"");
    ...
    private void TdcMove(string mcNo, string lotNo, string opNo, string layerNo, Logger log)
    {
        try
        {
            ...
            log.ConnectionLogger.Write(0, MethodBase.GetCurrentMethod().Name, "Normal", "WCFService", "TDC", 0, "MoveLot", "LotRequest", "");
            if (res.HasError)
            {
                if (res.ErrorCode == "06" || res.ErrorCode == "02")
                {
                    tdcService.MoveLot(lotNo, mcNo, opNo, layerNo);
                    log.ConnectionLogger.Write(0, MethodBase.GetCurrentMethod().Name, "Normal", "WCFService", "TDC", 0, "MoveLot", res.ErrorMessage, "");
                }
            }
        }
        catch (Exception ex)
        {
            log.ConnectionLogger.Write(0, MethodBase.GetCurrentMethod().Name, "Error", "WCFService", "TDC", 0, "", ex.Message.ToString(), "");
        }
    }
